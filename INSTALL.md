...
```bash
curl -fsSL https://raw.githubusercontent.com/xinze260306/purification-skills/main/install-youyouyi.sh | bash
```

或者使用 `wget`:

```bash
wget -qO- https://raw.githubusercontent.com/xinze260306/purification-skills/main/install-youyouyi.sh | bash
```
...
cp -r purification-skills/skills/youyouyi-evolution ~/.openclaw/workspace/skills/
...
```bash
# 游游奕
ls ~/.openclaw/workspace/skills/youyouyi-purification/SKILL.md
ls ~/.openclaw/workspace/skills/youyouyi-evolution/SKILL.md
